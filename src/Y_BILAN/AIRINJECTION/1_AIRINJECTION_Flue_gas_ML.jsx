...
const AIRINJECTIONFlueGasParameters = ({ innerData, currentLanguage = 'fr' }) => {
  ...
  const FG_CO2_EAU = CO2_kg_m3(masses_FG_out_AIRINJECTION.CO2);
  const FG_H2O_EAU = H2O_kg_m3(masses_FG_out_AIRINJECTION.H2O);
  const FG_O2_EAU = O2_kg_m3(masses_FG_out_AIRINJECTION.O2);
  const FG_N2_EAU = N2_kg_m3(masses_FG_out_AIRINJECTION.N2);
