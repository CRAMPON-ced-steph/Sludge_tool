...
const AIRINJECTIONDesign = ({ innerData, setInnerData, currentLanguage = 'fr' }) => {
  ...
  const [Parameters_airinjection, setParameters_airinjection] = useState(() => {
    return {
      FlueGasFlow_norm: innerData?.FG_humide_tot || defaultParameters_airinjection.FlueGasFlow_norm,
      Tempe_flue_gas: defaultParameters_airinjection.Tempe_flue_gas,
  ...
  // Extract parameters
  const FlueGasFlow_norm = Parameters_airinjection['FlueGasFlow_norm'];
  const Tempe_flue_gas = Parameters_airinjection['Tempe_flue_gas'];
  ...
  useEffect(() => {
    ...
    const flueGasFlow = Parameters_airinjection.FlueGasFlow_norm;
    const temperature = Parameters_airinjection.Tempe_flue_gas;
    const velocityTarget = Parameters_airinjection.VelocityTarget;
