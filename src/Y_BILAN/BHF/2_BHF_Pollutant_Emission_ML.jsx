...
const FlueGasPollutantEmission = ({ innerData, currentLanguage = 'fr' }) => {
  ...
  const Conso_CAP = conso_CAP_SOx + conso_CAP_HCl + conso_CAP_HF;

  // Calculate costs
  const cout_conso_reactifs = (
    (reagentsTypes?.CaCO3 ? Conso_CaCO3 / 1000 * reagentsTypes.CaCO3.cost : 0) +
    (reagentsTypes?.CaO ? Conso_CaO / 1000 * reagentsTypes.CaO.cost : 0) +
    (reagentsTypes?.CaOH2wet ? Conso_CaOH2wet / 1000 * reagentsTypes.CaOH2wet.cost : 0) +
    (reagentsTypes?.CaOH2dry ? Conso_CaOH2dry / 1000 * reagentsTypes.CaOH2dry.cost : 0) +
    (reagentsTypes?.NaOH ? Conso_NaOH / 1000 * reagentsTypes.NaOH.cost : 0) +
    (reagentsTypes?.NaOHCO3 ? Conso_NaOHCO3 / 1000 * reagentsTypes.NaOHCO3.cost : 0) +
    (reagentsTypes?.CAP ? Conso_CAP / 1000 * reagentsTypes.CAP.cost : 0)
  );

  // Calculate CO2 emissions
  const CO2_total_reactifs = (
    (reagentsTypes?.CaCO3 ? Conso_CaCO3 / 1000 * reagentsTypes.CaCO3.co2PerTrip : 0) +
    (reagentsTypes?.CaO ? Conso_CaO / 1000 * reagentsTypes.CaO.co2PerTrip : 0) +
    (reagentsTypes?.CaOH2wet ? Conso_CaOH2wet / 1000 * reagentsTypes.CaOH2wet.co2PerTrip : 0) +
    (reagentsTypes?.CaOH2dry ? Conso_CaOH2dry / 1000 * reagentsTypes.CaOH2dry.co2PerTrip : 0) +
    (reagentsTypes?.NaOH ? Conso_NaOH / 1000 * reagentsTypes.NaOH.co2PerTrip : 0) +
    (reagentsTypes?.NaOHCO3 ? Conso_NaOHCO3 / 1000 * reagentsTypes.NaOHCO3.co2PerTrip : 0) +
    (reagentsTypes?.CAP ? Conso_CAP / 1000 * reagentsTypes.CAP.co2PerTrip : 0)
  );
  ...
  const Residus = { DryBottomAsh, WetBottomAsh };
