...
const WATER_INJECTION_Report = ({ innerData = {}, currentLanguage = 'fr' }) => {
  ...
  const FG_OUT_vol = innerData.FG_WATER_INJECTION_OUT || innerData.FG_OUT_vol || innerData.FG_RK_OUT || _nm3Computed;
  ...
  const reactifConsumption = [
    { label: t('CaO [kg/h]'), value: innerData.Conso_CaO },
    { label: t('Ca(OH)₂ sec [kg/h]'), value: innerData.Conso_CaOH2_dry },
    { label: t('NaHCO₃ [kg/h]'), value: innerData.Conso_NaOHCO3 },
