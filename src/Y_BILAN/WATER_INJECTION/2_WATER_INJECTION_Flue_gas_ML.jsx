...
const WATER_INJECTIONFlueGasParameters = ({ innerData, currentLanguage = 'fr' }) => {
  ...
  const FG_CO2_EAU = CO2_kg_m3(masses_FG_out_WATER_INJECTION.CO2);
  const FG_H2O_EAU = H2O_kg_m3(masses_FG_out_WATER_INJECTION.H2O);
  const FG_O2_EAU = O2_kg_m3(masses_FG_out_WATER_INJECTION.O2);
  const FG_N2_EAU = N2_kg_m3(masses_FG_out_WATER_INJECTION.N2);
