...
const REACTORFlueGasParameters = ({ innerData, currentLanguage = 'fr' }) => {
  ...
  const FG_CO2_EAU = CO2_kg_m3(masses_FG_out_REACTOR.CO2);
  const FG_H2O_EAU = H2O_kg_m3(masses_FG_out_REACTOR.H2O);
  const FG_O2_EAU = O2_kg_m3(masses_FG_out_REACTOR.O2);
  const FG_N2_EAU = N2_kg_m3(masses_FG_out_REACTOR.N2);

  const FG_humide_EAU_tot = FG_CO2_EAU + FG_O2_EAU + FG_N2_EAU + FG_H2O_EAU;
  const FG_sec_EAU_tot = FG_CO2_EAU + FG_O2_EAU + FG_N2_EAU;
  ...
  if (innerData) {
    ...
    innerData.FG_sec_EAU_tot = FG_sec_EAU_tot;
